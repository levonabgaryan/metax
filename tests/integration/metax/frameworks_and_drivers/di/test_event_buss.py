...
@pytest.mark.asyncio
async def test_message_buss_is_singleton(metax_app_for_integration_tests: MetaxAppLifespanManager) -> None:
    ...
    event_bus_3 = await metax_container_for_integration_tests.patterns_container.container.event_bus.async_()
