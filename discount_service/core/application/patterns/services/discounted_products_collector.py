...
#         started_time_of_collected: datetime,
...
#         self._started_time_of_collected = started_time_of_collected
#
#     @abstractmethod
#     def collect_discounted_products_from_retailer(self) -> AsyncIterator[DiscountedProduct]:
#         pass
#
#     async def _save_discounted_products(self, discounted_products: list[DiscountedProduct]) -> None:
